        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form action="cetak2.php" method="post" target="_blank" class="d-inline">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['filter_tgl'])) {
                                        ...
                                        $get = mysqli_query($c, "select * from masuk m, produk p where m.idproduk=p.idproduk and tanggal BETWEEN '$mulai' and DATE_ADD('$selesai',INTERVAL 1 DAY)");
                                    } else {
