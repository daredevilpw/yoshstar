                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    $get = mysqli_query($c, "select * from supplier");
                                    $i = 1;
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Ubah <?= $namasupplier; ?></h4>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            <input type="text" name="namasupplier" class="form-control" placeholder="Nama Supplier" value="<?= $namasupplier; ?>">
                                                            <input type="text" name="alamat" class="form-control mt-2" placeholder="Alamat Supplier" value="<?= $alamat; ?>">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="editsupplier">Submit</button>
                                        ...
                                        <div class="modal fade" id="delete<?=$idsupplier;?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <!-- Modal Header -->
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">Hapus <?=$namasupplier; ?></h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                    </div>
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="deletesupplier">Submit</button>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                                                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post">
                    ...
                    <!-- Modal footer -->
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="tambahsupplier">Submit</button>
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                    </div>
